...
export const metadata: Metadata = {
  title: "DMCA Copyright Policy - KumpulEnak",
  description: "Read our DMCA Copyright Policy regarding copyright respect, takedown request procedures, and counter-notification details.",
};
  ...
  return (
    <div className="container mx-auto px-4 md:px-8 py-10 max-w-3xl text-left text-white space-y-6">
      ...
      <ul className="list-disc list-inside text-sm text-foreground/80 space-y-2 pl-4">
        ...
        <li>Identification of the material that is claimed to be infringing and that is to be removed or access to which is to be disabled, including the exact URL(s) or link locations on KumpulEnak.</li>
        <li>Information reasonably sufficient to permit KumpulEnak to contact you, such as an address, telephone number, and email address.</li>
      ...
      <ul className="list-disc list-inside text-sm text-foreground/80 space-y-1.5 pl-4">
        ...
        <li>Your name, address, telephone number, and a statement that you consent to the jurisdiction of the Federal District Court for the judicial district in which your address is located, or if your address is outside the United States, for any judicial district in which KumpulEnak may be found, and that you will accept service of process from the person who provided the original infringement notification.</li>
      </ul>

      <h2 className="text-xl font-bold mt-6 text-white/90">5. Repeat Infringer & Account Termination Policy</h2>
      <p className="text-sm text-foreground/80 leading-relaxed">
        KumpulEnak maintains a strict policy to terminate access privileges, block syndication feeds, or restrict IP blocks of users and API channels who are determined to be repeat infringers.
      </p>

      <h2 className="text-xl font-bold mt-6 text-white/90">6. Abuse and False Claims Warning</h2>
      <p className="text-sm text-foreground/80 leading-relaxed">
        Under Section 512(f) of the DMCA, any person who knowingly materially misrepresents that material or activity is infringing may be subject to liability for damages, including costs and attorneys&apos; fees, incurred by the alleged infringer or by KumpulEnak.
      </p>
      ...
      <div className="bg-[#1A1A1A] border border-white/5 p-4 rounded-xl space-y-1 font-mono text-xs text-[#AAAAAA] mt-3">
        <p className="text-white font-semibold">KumpulEnak Copyright Agent</p>
        <p>Email: copyright@kumpulenak.com</p>
        <p>Suite 402, 100 Town Road, Georgetown, KY 40324</p>
      </div>

      <h2 className="text-xl font-bold mt-6 text-white/90">8. Legal Notice & Jurisdiction</h2>
      <p className="text-sm text-foreground/80 leading-relaxed">
        This DMCA Copyright Policy is governed by the federal laws of the United States. KumpulEnak operates in full compliance with the safe harbor regulations for service providers under Title 17 of the United States Code.
      </p>
    </div>
  );
}
