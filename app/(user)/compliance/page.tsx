...
export const metadata: Metadata = {
  title: "18 U.S.C. 2257 Compliance - KumpulEnak",
  description: "Read our 18 U.S.C. 2257 record-keeping compliance statement.",
};
  ...
  return (
    <div className="container mx-auto px-4 md:px-8 py-10 max-w-3xl text-left text-white space-y-6">
      ...
      <p className="text-sm text-foreground/80 leading-relaxed">
        KumpulEnak is a modern media indexer and video search platform. We take content compliance and federal record-keeping regulations with the utmost seriousness. The following statement sets forth our compliance procedures under 18 U.S.C. § 2257 and 28 C.F.R. Part 75.
      </p>
      ...
      <p className="text-sm text-foreground/80 leading-relaxed">
        KumpulEnak does not produce, film, or co-produce any of the visual materials indexed or displayed on this platform. Pursuant to the federal record-keeping regulations, KumpulEnak is exempt from the requirement to maintain records directly, as it acts solely as a secondary distributor or indexer. All record-keeping obligations remain with the primary producers who generated the material.
      </p>
      ...
      <div className="bg-[#1A1A1A] border border-white/5 p-4 rounded-xl space-y-1 font-mono text-xs text-[#AAAAAA] mt-3">
        <p className="text-white font-semibold">KumpulEnak Compliance Operations</p>
        <p>Attention: Custodian of Records</p>
        <p>Suite 402, 100 Town Road, Georgetown, KY 40324</p>
        <p>Email: compliance@kumpulenak.com</p>
      </div>

      <h2 className="text-xl font-bold mt-6 text-white/90">6. Legal Jurisdiction</h2>
      <p className="text-sm text-foreground/80 leading-relaxed">
        This compliance statement is issued pursuant to the laws of the United States. KumpulEnak reserves the right to amend, update, or remove content links that fail to verify or provide satisfactory documentation of compliance with these regulations.
      </p>
    </div>
  );
}
